...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[LAYER_1] = LAYOUT(
		XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, /*|*/ KC_LBRC, KC_7,        KC_8,   KC_9,   KC_MINS,   DF(LAYER_GAME_0),
	...
	[LAYER_2] = LAYOUT(
		XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, /*|*/ XXXXXXX, KC_F7,   KC_F8,   KC_F9,   KC_F11,  DF(LAYER_GAME_0),
	...
	[LAYER_GAME_0] = LAYOUT(
		KC_ESC, KC_Q,    KC_G,             KC_E,    KC_R,    KC_T,   /*|*/ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, DF(LAYER_0),
		KC_TAB, KC_A,    KC_S,             KC_W,    KC_D,    KC_F,   /*|*/ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
		KC_DEL, KC_Z,    KC_X,             KC_C,    KC_V,    KC_B,   /*|*/ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
		        XXXXXXX, MO(LAYER_GAME_1), KC_LCTL, KC_LSFT, KC_SPC, /*|*/ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
	),
	[LAYER_GAME_1] = LAYOUT(
